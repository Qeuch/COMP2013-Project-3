    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path="/add-product" element={<Authorized role="admin"><ProductForm /></Authorized>} />
          <Route path="/edit-product/:id" element={<Authorized role="admin"><ProductForm /></Authorized>} />
